...
public class Elevator extends SubsystemBase {
  ...
  public void setPreset(ElevatorIOInputs.ElevatorState state) {
    ...
    // if (state == ElevatorIOInputs.ElevatorState.CoralL3 || state ==
    // ElevatorIOInputs.ElevatorState.CoralL4) {
    //   double l3Pos = ElevatorIOInputs.ElevatorState.CoralL3.getEncoderPosition(); // Expected:
    // 3.82
    //   double l4Pos = ElevatorIOInputs.ElevatorState.CoralL4.getEncoderPosition(); // Expected:
    // 7.375
