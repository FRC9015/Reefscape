...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(0.75).withKI(0).withKD(0).withKS(0.14364).withKV(0.78001);

  // The closed-loop output type to use for the steer motors;
  // This affects the PID/FF gains for  steer motors
  ...
  public static final CANBus kCANBus = new CANBus("2025bot", "./logs/example.hoot");
  ...
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.04638671875);
